...
[CustomEditor(typeof(CustomReadme))]
[InitializeOnLoad]
public class ReadmeEditor : Editor
{
    ...
    void OpenScene(SceneReference scene)
    {
    ...
    static CustomReadme SelectReadme()
    {
        ...
        if (ids.Length == 1)
        {
            ...
            return (CustomReadme)readmeObject;
        }
        else
        {
    ...
    {
        var readme = (CustomReadme)target;
        Init();
    ...
    public override void OnInspectorGUI()
    {
        ...
        foreach (var scene in readme.scenes)
        {
            if (GUILayout.Button("Åben " + scene.name, ButtonStyle))
            {
